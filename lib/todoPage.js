...
function createTodoPage(projectList, project) {
  ...
  var button = createAddButton(project);
...
function createForm(projectList, project) {
  ...
  submit.addEventListener('click', function () {
    project.add(new _todo.Todo(titleInput.value, descriptionInput.value, dueDateInput.value, priorityInput.value, notesInput.value));
    createTodoPage(projectList, project);
  });
